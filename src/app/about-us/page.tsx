export default function AboutUsPage() {
    return (
      <article className="w-3/4 mt-10 mx-auto bg-outline">
          ...
          Thank you for visiting this site. We are a two-man team (a student and a coder)! I&apos;m dating a nurse, and I thought working on salary information would be useful for her because she will soon be negotiating salary offers.
          <br /><br />
