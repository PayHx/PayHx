// Simplified from https://github.com/sersavan/shadcn-multi-select-component
// Bouncing animation removed
// Select all removed
// Max count becomes max allowed
...
>(
  (
    ...
    // Limit total selected values to max count
    const maxCountReached = selectedValues.length >= maxCount;
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                {options.map((option) => {
                  ...
                  const isDisabled = maxCountReached && !isSelected;
                  return (
                    <CommandItem
                      key={option.value}
